...
const EditProfile = ({ theme }) => {
  ...
  const handleImageChange = (e) => {
    ...
    if (file) {
      ...
      axios.post("https://healthbro-zkhz.onrender.com/api/FileUpload/BackEndServer", formData)
        .then((response) => {
          if (response.data !== "default.jpg") {
            setImagePath(response.data);
            setProfileImage(URL.createObjectURL(file)); 
            axios.post("https://healthbro-zkhz.onrender.com/api/FileUpload/FtpServer", formData)
              .then((ftpResponse) => {
  ...
  const handleSave = async (e) => {
    ...
    axios.put(`https://healthbro-zkhz.onrender.com/api/User/UpdateUser/${token}`, updatedUserData,{
      headers: {
