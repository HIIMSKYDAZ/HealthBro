...
namespace HealthBro_BackEnd
{
    public class Program
    {
        public static int SaltLength = 64;
        public static string ftpUrl = "ftp.nethely.hu";
        public static string ftpUserName = "Healthbro";
        public static string ftpPassword = "Healthbro";
        ...
        {
            LoggedInUsers["token"] = new User { Permission = new Permission { Level = 9 } };
