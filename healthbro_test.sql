...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Jan 21. 23:37
...
--
-- Adatbázis: `healthbro_test`
--
CREATE DATABASE IF NOT EXISTS `healthbro_test` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_hungarian_ci;
USE `healthbro_test`;
...
--
ALTER TABLE `planexercises`
  MODIFY `PlanExerciseID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
